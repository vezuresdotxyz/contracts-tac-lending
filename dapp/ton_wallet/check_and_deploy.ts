...
const privateKey =
  "1209c23cd0bdd8ac708b29a29694955e9edf8560bdb2744b6cdde4104e0cf5edfea74ae47fc9ba7c7864bc5a8d385d9e4ecf5d9d330126df3b5c2a98e4b91184";

const httpProvider = new TonWeb.HttpProvider(
  "https://ton-testnet.core.chainstack.com/0fa8c05c7bf921a575e20f051a312a84/api/v2/jsonRPC"
);
...
async function deployWallet() {
  try {
    ...
    if (balance === "0") {
      console.error(
        "Wallet has no balance. Please add funds before deploying."
      );
      return;
    }
